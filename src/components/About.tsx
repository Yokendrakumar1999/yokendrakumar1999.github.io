...
<div className="mt-6 text-md dark:prose-invert max-w-none text-[var(--muted)]">
  <p>
    DevOps Engineer focused on building scalable, secure, and observable cloud infrastructure across AWS and DigitalOcean.
  </p>

  <p>
    I specialize in CI/CD automation, Kubernetes-based microservices, and Infrastructure as Code using Terraform and Helm, with a strong emphasis on reliability, performance, and developer experience.
  </p>
</div>
